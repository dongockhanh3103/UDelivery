...
import com.udelivery.zions.delivery.Activity.Activity.mvp.order.model.DetailCustomer;
...
import com.udelivery.zions.delivery.Activity.Activity.mvp.products.ProductsActivity;
import com.udelivery.zions.delivery.Activity.Activity.utils.DialogNotif;
import com.udelivery.zions.delivery.Activity.Activity.utils.DialogVerifyChangeStatusCode;
...
public class DetailOrderActivity extends BaseActivity implements IDetailOrder.View {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    tvCustomerAddress.setOnClickListener(new OnClickListener() {
      @Override
      public void onClick(View v) {
        ...
        intent.putExtra("CUSTOMER_ADDRESS",detailCustomers.get(0).addressCustomer);
        startActivity(intent);
      }
    });
  ...
  void init() {
   ...
   // btnFinderRoad = findViewById(R.id.btn_direct_map);
